...
import { 
  ...
  Trash2, Edit, CreditCard, Briefcase, X, Save 
} from "lucide-react";
...
export function Pacientes() {
  ...
  return (
    <div className="p-4 md:p-8 max-w-7xl mx-auto min-h-screen bg-gray-50 font-sans">
      ...
      {/* MODAL SIMPLIFICADO (À PROVA DE ERROS) */}
      {isModalOpen && (
